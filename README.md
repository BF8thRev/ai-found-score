...
| Path | What it is |
|---|---|
| `/` | Landing page (site copy v2): hero with the sample report's headline answer, what the report shows, how it works, the ladder (free Snapshot → $99 Full Audit → $499 Be the Answer; AI Defense mentioned once, never sold), FAQ, and the free-report form (shows the owner their 3 questions first, then asks for an optional email) |
