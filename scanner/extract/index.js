...
export { buildReport, formatWindow, answerKey, applyHeadlineConfirmation, pickDescriptors, MAX_DESCRIPTORS } from './build.js';
...
export { verifyAnswer, verifyBusinesses, verifyFacts, verifyDescriptors, matchOwner, factStatus, ownerFact } from './verify.js';
...
export { baselineFixes, businessDetails, gbpDescription, faqAnswer, localBusinessJsonLd, napBlock } from './fixes.js';
